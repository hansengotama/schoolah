        ...
        var app = new Vue({
            ...
            methods: {
                ...
                getStudentId() {
                    ...
                    this.getTuitions(Cookies.get("student_id"))
                },
                ...
                getTuitions(studentId) {
                    axios.get("{{ url('guardian/get-tuitions') }}/"+studentId)
                    .then(function (response) {
                        if(response.status) {
                ...
                showDetailModal(id) {
                    axios.get("{{ url('guardian/get-history-detail') }}/"+id)
                    .then(function (response) {
                        if(response.status) {
                ...
                saveImage() {
                    ...
                    axios.post("{{ url('guardian/save-image') }}", requestData)
                    .then(function (response) {
                        if(response.data) {
                            app.popUpSuccess()
                            app.resetForm()
                            app.getTuitions(Cookies.get("student_id"))
